...
# templates = Jinja2Templates(directory="week8/connection_pool/templates")
...
#     # for _ in range(10):
#     #     connection()
#     return FileResponse("week8/connection_pool/templates/index.html")
...
def connection():
    ...
    print(f"{version[0]}, spent {connection_time} ms")
    db.close()
...
# app.mount("/static", StaticFiles(directory="week8/connection_pool/static"), name="static")
